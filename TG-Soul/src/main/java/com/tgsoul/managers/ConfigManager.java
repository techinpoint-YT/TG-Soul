...
public class ConfigManager {
    ...
    public boolean isResourcePackEnabled() { return config.getBoolean("soul.resource-pack.enabled", true); }
    public String getResourcePackUrl() { return config.getString("soul.resource-pack.url", ""); }
    public String getResourcePackHash() { return config.getString("soul.resource-pack.hash", ""); }
    public boolean isResourcePackRequired() { return config.getBoolean("soul.resource-pack.required", false); }
    public String getResourcePackPrompt() { return config.getString("soul.resource-pack.prompt", "§6TGSoul Resource Pack\\n§7This pack adds custom soul textures and HUD elements.\\n§aWould you like to download it?"); }
